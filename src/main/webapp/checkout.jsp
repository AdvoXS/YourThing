...
<div class="super_container">
	...
	<div class="home">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="/resources/images/checkout.jpg" data-speed="0.8"></div>
						...
						<div class="checkout_container d-flex flex-xxl-row flex-column align-items-start justify-content-start">
							...
							<div class="cart_total">
								<div class="cart_total_inner checkout_box">
									...
									<div class="checkout_button trans_200"><a href="checkout.jsp">place order</a></div>
								</div>
							</div>
